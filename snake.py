# Description: This is a simple snake game using python and pygame
import pygame
import time
import random
import sys
...
def init_vars():
    global head_pos , snake_body , score , food_pos , food_spawn , direction
    direction = 'RIGHT'
    head_pos = [120,60]
    snake_body = [[120,60]]
...
while True:
    ...
    #apple and snake body collision
